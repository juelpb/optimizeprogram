# Input script for global analysis in Abaqus
import numpy as np
...
t_height=185
girder_def_mid=9.1279
girder_def_south=0.4327
girder_def_north=0.4317
cable_def_mid=13.4423
tower_def=0.7709
cable_sf_max=201556032.0
hanger_sf_max=840031.875
girder_area=2.3970142857142855
girder_I11=5.1554
girder_I22=186.21285714285713
girder_It=18.31953846153846
mass=13056.397807890206
i11=15327.716512221252
i22=857625.2198866511
# LINE 28
#
...
step.time[2]=np.array([1e-12, 1, 1e-14, 1])
...
cable.cs.I11=0.75*cable.cs.A**2/(4*np.pi)*0.01
cable.cs.I22=0.75*cable.cs.A**2/(4*np.pi)*0.01
